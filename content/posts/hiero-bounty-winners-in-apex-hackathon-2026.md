...
date = 2026-05-21
featured_image = "/images/apex-2026-hiero-bounty-winners/hero.png"
categories = ["Blog"]
...
[[authors]]
name = "Jessy Ssebuliba and Angelina Ceppaluni"
organization = "Hiero"
...
Hiero is the open-source project that the Hedera network is built on. Strong applications on Hedera depend on strong libraries, SDKs, and infrastructure tooling underneath them, and the Hiero bounty exists to push that layer forward.
