...
[[authors]]
name = "Daniel Ntege and Sophie Bulloch"
+++

A growing number of developers have become involved in the Hiero community. To visualise this shift, we have been developing community analytics at [hiero-hackers/analytics](https://github.com/hiero-hackers/analytics). 
...
The charts above come from our community analytics work at [hiero-hackers/analytics](https://github.com/hiero-hackers/analytics). If you're curious about the data, or want to help improve the tooling, add new charts, or pitch in on labelling issues — the repo is open and we'd love the help.
