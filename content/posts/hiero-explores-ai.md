+++
title = "Hiero Explores AI! Meetup Events Happening Soon"
featured_image = "/images/hiero-explores-ai.png"
date = 2026-09-14T00:00:00-07:00
categories = ["Blog"]
abstract = "Join Hiero maintainers in the next Meetup events exploring AI tooling."
[[authors]]
...
AI-powered development tools can provide more than code generation. When used effectively, they can help developers plan implementation, identify potential improvements, accelerate code reviews, and make collaboration easier for maintainers and contributors.
...
As AI becomes part of everyday development, projects need to consider questions around acceptable use, disclosure, provenance, licensing, DCO sign-off, and security review.

This session is useful for maintainers, contributors, TSC members, LFDT staff, and members of the broader Linux Foundation Decentralized Trust ecosystem.

👉 [Register on Meetup: AI × Decentralized Trust — Kickoff of the LFDT AI Working Group](https://www.meetup.com/lfdt-sf/events/316485550/)

## 💜 Get Involved In Hiero

Hiero is built by an open community of developers, maintainers, contributors, organizations, and users working together under Linux Foundation Decentralized Trust.

Interested in getting involved?

- Explore the [Hiero repositories](https://github.com/hiero-ledger)
- Join the Hiero community on [Discord](https://discord.com/invite/hyperledger)
- Attend our [open community and technical meetings](https://zoom-lfx.platform.linuxfoundation.org/meetings/hiero?view=week)
- Find an [issue](https://hiero.org/issues) and make your first contribution
