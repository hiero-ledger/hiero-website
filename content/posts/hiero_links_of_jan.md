+++
title = "Hiero Links Of January"
featured_image = "/images/Jan-Links.png"
...
This month featured a lot of new and exciting updates within the Hiero Organization. 
Below are links to some of things that happend last month. **Check it out!**

---

**Angelina Ceppaluni** Has updated the both the Hiero-Website 
[Readme](https://github.com/hiero-ledger/hiero-website/blob/main/README.md) and the C++ 
[Readme](https://github.com/hiero-ledger/hiero-sdk-cpp/blob/main/README.md) 
to include instructions on setting up both the Hiero-Website 
and C++ SDK on a users local machine

**Emiliyan Kadiyski** Implemented 
