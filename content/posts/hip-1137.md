...
featured_image = "/images/Block_Node_Discoverability.png"
...
**Multiple Endpoints for each Node**: The registry supports endpoints for block nodes, mirror nodes, RPC relays, and general services in a pluggable architecture.
Each endpoint may provide additional information specific to the endpoint service, such as provided APIs.
