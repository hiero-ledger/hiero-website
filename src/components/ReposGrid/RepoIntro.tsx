...
export default function RepoIntro({ heading, text }: RepoIntroProps) {
  return (
    <div>
      ...
      <div className="max-w-full text-lg whitespace-pre-line tracking-normal md:max-w-[560px]">
        {text}
      </div>
