  ...
  const networks = [
    {
      ...
      hoverBg: "hover:border-[#0077b5] hover:bg-[#0077b5]",
      icon: (
        <svg
          viewBox="0 0 24 24"
    ...
    },
    {
      ...
      hoverBg: "hover:border-[#54A9EB] hover:bg-[#54A9EB]",
      icon: (
        <svg
          viewBox="0 0 24 24"
          className="h-[1.05rem] w-[1.05rem] fill-current">
    ...
    },
    {
      ...
      hoverBg: "hover:border-black hover:bg-black",
      icon: (
        <svg
          viewBox="0 0 32 32"
          className="h-[1.05rem] w-[1.05rem] fill-current">
    ...
    },
    {
      ...
      hoverBg: "hover:border-charcoal hover:bg-charcoal",
      icon: (
        <svg
          viewBox="0 0 24 24"
          className="h-[1.05rem] w-[1.05rem] fill-current">
    ...
    <div className="flex flex-wrap gap-2">
      {networks.map(n => (
        <a
          ...
          className={`grid h-10 w-10 place-items-center rounded-full border border-charcoal/22 text-charcoal/70 transition-[background-color,border-color,color] duration-200 ease-out hover:text-white focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-red motion-reduce:transition-none ${n.hoverBg}`}>
          {n.icon}
        </a>
      ))}
    </div>
